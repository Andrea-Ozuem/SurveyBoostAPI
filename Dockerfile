...
# Install stratifyR dependencies and package (from CRAN archive)
RUN R -e "install.packages(c('fitdistrplus', 'zipfR', 'actuar', 'triangle', 'mc2d'), repos='https://cloud.r-project.org')" \
